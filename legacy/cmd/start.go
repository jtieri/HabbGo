...
import (
	...
	"github.com/jtieri/habbgo/legacy/game/service"
	"github.com/jtieri/habbgo/legacy/internal"
	"github.com/jtieri/habbgo/legacy/server"
...
func buildGameServices(
	...
	ns := navigator2.NewNavigatorService(
		ctx,
	...
	ps := player2.NewPlayerService(ctx,
	...
	return &service.Proxies{
		Rooms:     room2.NewProxy(rs.Channels()),
		Items:     item2.NewProxy(is.Channels()),
		Navigator: navigator2.NewProxy(ns.Channels()),
		Players:   player2.NewProxy(ps.Channels()),
	}
}
