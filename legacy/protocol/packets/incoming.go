...
import (
	...
	encoding2 "github.com/jtieri/habbgo/legacy/protocol/encoding"
)
...
func NewIncoming(rawHeader []byte, payload *bytes.Buffer) IncomingPacket {
	packet := IncomingPacket{Header: string(rawHeader), HeaderId: encoding2.DecodeB64(rawHeader), Payload: payload}
	return packet
}
