...
import (
	...
	commands2 "github.com/jtieri/habbgo/legacy/protocol/commands"
...
func (r *Router) RegisterHandshakeCommands() {
	r.RegisteredCommands[206] = commands2.INIT_CRYPTO
	r.RegisteredCommands[202] = commands2.GENERATEKEY  // older clients
	r.RegisteredCommands[2002] = commands2.GENERATEKEY // newer clients
	r.RegisteredCommands[5] = commands2.VERSIONCHECK   // 1170 - VERSIONCHECK in later clients? v26+? // TODO figure out exact client revisions when these packet headers change
	r.RegisteredCommands[6] = commands2.UNIQUEID
	r.RegisteredCommands[181] = commands2.GET_SESSION_PARAMETERS
	r.RegisteredCommands[204] = commands2.SSO
	r.RegisteredCommands[4] = commands2.TRY_LOGIN
	r.RegisteredCommands[207] = commands2.SECRETKEY
}
...
func (r *Router) RegisterRegistrationCommands() {
	r.RegisteredCommands[9] = commands2.GETAVAILABLESETS
	r.RegisteredCommands[49] = commands2.GDATE
	r.RegisteredCommands[42] = commands2.APPROVENAME
	r.RegisteredCommands[203] = commands2.APPROVE_PASSWORD
	r.RegisteredCommands[197] = commands2.APPROVEEMAIL
	r.RegisteredCommands[43] = commands2.REGISTER
}

// RegisterPlayerCommands registers the player related Command handlers.
func (r *Router) RegisterPlayerCommands() {
	r.RegisteredCommands[7] = commands2.GET_INFO
	r.RegisteredCommands[8] = commands2.GET_CREDITS
	r.RegisteredCommands[157] = commands2.GETAVAILABLEBADGES
	r.RegisteredCommands[228] = commands2.GET_SOUND_SETTING
	r.RegisteredCommands[315] = commands2.TestLatency
}

// RegisterNavigatorCommands registers the Navigator related Command handlers.
func (r *Router) RegisterNavigatorCommands() {
	r.RegisteredCommands[150] = commands2.NAVIGATE
	r.RegisteredCommands[151] = commands2.GETUSERFLATCATS
	// 21: GETFLATINFO
	// 23: DELETEFLAT
	// 24: UPDATEFLAT
	// 25: SETFLATINFO
...
func (r *Router) RegisterRoomCommands() {
	r.RegisteredCommands[182] = commands2.GETINTERST
	r.RegisteredCommands[2] = commands2.ROOM_DIRECTORY
	r.RegisteredCommands[126] = commands2.GETROOMAD
	r.RegisteredCommands[60] = commands2.G_HMAP
	r.RegisteredCommands[61] = commands2.G_USRS
	r.RegisteredCommands[62] = commands2.G_OBJS
	r.RegisteredCommands[64] = commands2.G_STAT
	r.RegisteredCommands[115] = commands2.GOAWAY
	r.RegisteredCommands[75] = commands2.MOVE
	/*
...
func (r *Router) RegisterRoomUserCommands() {
	r.RegisteredCommands[88] = commands2.STOP
}
